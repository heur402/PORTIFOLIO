            ...
            <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                ...
                >
                    <div className="relative w-75 h-75 lg:w-96 lg:h-96">
                        {/* image */}
                        <div
                            className="absolute -inset-4 lg:-inste-20 bg-linear-to-l from-[#f97316] 
                ...
                >
                    ...
                    <button
                        className={`w-full sm:w-auto inline-flex border-2 border-orange-500 items-center justify-center
                                    py-2 px-4 sm:px-6 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)] duration-300
                                    rounded-full text-base sm:text-lg font-semibold transition-all  transform
