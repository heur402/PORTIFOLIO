...
const Hero = ({ darkMode }) => {
    ...
    return (
        <div className='relative overflow-hidden min-h-screen flex flex-col'>
            ...
            >
                <div className='container mx-auto flex px-4 sm:px-8 lg:px-14 py-8 lg:py-32 flex-col
                lg:flex-row items-center justify-between lg:mt-0 mt-14'>
                        ...
                        <div className='w-full pt-4 sm:pt-6'>
                            ...
                            >
                                <a href={cv} download className='w-full sm:w-auto'>
                                    <button className='w-full sm:w-auto inline-flex items-center justify-center text-white bg-linear-to-r from-orange-500 to-orange-300
                    ...
                    >
                        <div className='relative w-4/5 sm:w-3/4 lg:w-full'>
                            ...
                            <img
                                src={hi}
                                alt="Hi icon"
                                className='absolute -top-4 sm:top-4 left-6 sm:left-20 w-14 h-14 sm:h-20 sm:w-20 object-contain animate-bounce opacity-90 z-10'
                            />
                        </div>
                    </div>
                ...
                {/* Decorative Circle */}
                <div className={`absolute -top-20 -left-14 w-40 h-40 sm:w-64 sm:h-64 ${theme.decorativeCircle} 
